                                        ...
                                        <div>
                                            ...
                                            <div className="flex gap-3">
                                                <button onClick={() => setForm({ ...form, result_status: 'PASS' })}
                                                    className={`flex-1 py-4 rounded-2xl font-bold text-sm transition-all flex items-center justify-center gap-2 border-2 ${
                                                        form.result_status === 'PASS' ? 'bg-emerald-500 border-emerald-500 text-white shadow-lg scale-[1.02]' : 'bg-white border-gray-100 text-gray-400 hover:border-emerald-200'
                                                    }`}>
                                                    {form.result_status === 'PASS' ? '✓ Passed' : 'Pass'}
                                                </button>
                                                <button onClick={() => setForm({ ...form, result_status: 'FAIL' })}
                                                    className={`flex-1 py-4 rounded-2xl font-bold text-sm transition-all flex items-center justify-center gap-2 border-2 ${
                                                        form.result_status === 'FAIL' ? 'bg-rose-500 border-rose-500 text-white shadow-lg scale-[1.02]' : 'bg-white border-gray-100 text-gray-400 hover:border-rose-200'
                                                    }`}>
